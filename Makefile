...
# translation
SOURCES = zoomtocoordinates.py ui_zoomtocoordinates.py __init__.py zoomtocoordinatesdialog.py
#TRANSLATIONS = i18n/zoomtocoordinates_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = zoomtocoordinates

PY_FILES = zoomtocoordinates.py zoomtocoordinatesdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_zoomtocoordinates.py
